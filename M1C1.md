...
1. First, evaluate your knowledge of the data analytics process by considering whether the following statements apply to you:
...
2. Data analysts use a variety of tools, including software and programming languages, to analyze data. You will be most successful in an advanced certificate program if you’re able to use spreadsheets, SQL, Tableau, and R, which are covered in this program. Consider whether the following statements apply to you:
